#!/usr/bin/env python3
"""
Utility to generate sample transcripts in PDF and PNG formats for testing
...
def main():
    out_pdf = os.path.join(OUTPUT_DIR, 'transcript_L1_sample.pdf')
    out_img = os.path.join(OUTPUT_DIR, 'transcript_L1_sample.png')
